...
4. successful and complete, or represented by a traceable deterministic fact/anomaly/limitation
   projection whose source JSON Pointers map internally to a complete audit artifact;
